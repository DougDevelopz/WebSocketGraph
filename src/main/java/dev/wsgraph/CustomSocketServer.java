...
public class CustomSocketServer extends WebSocketServer {

    private final Logger logger = Logger.getLogger(CustomSocketServer.class.getName());

    public CustomSocketServer(int port) {
